...
class LoginSystem:
    ...
    def loginEmployee(self):
        ...
        # process
        process = self.playVoice("D:/Face-Recognition-Login-System/Voices/voice1.mp3")
        time.sleep(6)
        # End the process
        process.terminate()
        ...
        while True:
            ...
            if self.status == True:
                process = self.playVoice("D:/Face-Recognition-Login-System/Voices/voice2.mp3")
                time.sleep(4)
                process.terminate()
                break
        video_stream.stop()
    ...
    def employeeEntered(self):
        # Clear the screen first
        self.clearScreen()
        # Reset the value of self.status variable 
        self.status = False
